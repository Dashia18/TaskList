...
console: 
  > bundle:install -s mvn:org.apache.karaf.demos/org.apache.karaf.demos.command/4.0.7
...
http://karaf.apache.org/manual/4.0.7/developers-guide/extending-console.html
