...
[uninstalled] [4.0.7 ] wrapper           standard-4.0.7      Provide OS integration
[uninstalled] [4.0.7 ] obr               standard-4.0.7      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [4.0.7 ] config            standard-4.0.7      Provide OSGi ConfigAdmin support
[uninstalled] [4.0.7 ] region            standard-4.0.7      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-4.0.7      Provide Jetty engine support
[uninstalled] [4.0.7 ] http              standard-4.0.7      Implementation of the OSGI HTTP Service
[uninstalled] [4.0.7 ] http-whiteboard   standard-4.0.7      Provide HTTP Whiteboard pattern support
[uninstalled] [4.0.7 ] war               standard-4.0.7      Turn Karaf as a full WebContainer
[uninstalled] [4.0.7 ] deployers         standard-4.0.7      Provide Karaf deployer
[uninstalled] [4.0.7 ] kar               standard-4.0.7      Provide KAR (KARaf archive) support
[uninstalled] [4.0.7 ] webconsole-base   standard-4.0.7      Base support of the Karaf WebConsole
[uninstalled] [4.0.7 ] webconsole        standard-4.0.7      Karaf WebConsole for administration and monitoring
[uninstalled] [4.0.7 ] ssh               standard-4.0.7      Provide a SSHd server on Karaf
...
Maven builds the web application, web-4.0.7.war, and
